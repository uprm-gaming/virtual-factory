...
import com.virtualfactory.screen.layer.components.CharactersScreenController;
import com.virtualfactory.screen.layer.components.SupplierScreenController;
...
import com.virtualfactory.screen.layer.components.ActivityScreenController;
import com.virtualfactory.screen.layer.components.StorageCostScreenController;
import com.virtualfactory.screen.layer.components.PriorityScreenController;
import com.virtualfactory.screen.layer.components.PartScreenController;
import com.virtualfactory.screen.layer.components.MainMultipleControlsScreenController;
                                ...
                                panel(new PanelBuilder() {
                                    {
                                       // style(null);
                                        ...
                                        panel(new PanelBuilder("multipleControls_SMC") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new MainMultipleControlsScreenController());
...
//                                backgroundImage(panelBackgroundImage);
                                        ...
                                        panel(new PanelBuilder("winOC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new OperatorScreenController());
...
//                     
                                        ...
                                        panel(new PanelBuilder("winMC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new MachineScreenController());
                                        ...
                                        panel(new PanelBuilder("winSSC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new StorageStationScreenController());
                                        ...
                                        panel(new PanelBuilder("winPC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new PartScreenController());
                                        ...
                                        panel(new PanelBuilder("winAC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new ActivityScreenController());
                                        ...
                                        panel(new PanelBuilder("winOvC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new OverallScreenController());
...
//                                                        this.backgroundColor(de.lessvoid.nifty.tools.Color.BLACK);
                                        ...
                                        panel(new PanelBuilder("winSuC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new SupplierScreenController());
                                        ...
                                        panel(new PanelBuilder("winOrC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new OrderScreenController());
...
//                                                        this.backgroundColor(de.lessvoid.nifty.tools.Color.BLACK);
                                        ...
                                        panel(new PanelBuilder("winPrC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new PriorityScreenController());
                                        ...
                                        panel(new PanelBuilder("winULC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new UnitLoadScreenController());
                                        ...
                                        panel(new PanelBuilder("winAsOpC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new AssignOperatorScreenController());
                                        ...
                                        panel(new PanelBuilder("winFCC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new FlowChartScreenController());
                                        ...
                                        panel(new PanelBuilder("winGSC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new GameSetupScreenController());
                                        ...
                                        panel(new PanelBuilder("winChC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new CharactersScreenController());
                                        ...
                                        panel(new PanelBuilder("winASCC_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new StorageCostScreenController());
                                        ...
                                        panel(new PanelBuilder("winDashboard_Element") {
                                            {
                                                childLayoutAbsolute();
                                                controller(new DashboardScreenController());
