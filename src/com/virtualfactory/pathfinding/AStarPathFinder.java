package com.virtualfactory.pathfinding;

import java.util.ArrayList;
import java.util.Collections;

import com.virtualfactory.pathfinding.heuristics.ClosestHeuristic;
...
public class AStarPathFinder implements PathFinder {
	...
	public Path findPath(int sx, int sy, int tx, int ty) {
            ...
            sy += Params.terrainHeightLoc;
            tx += Params.terrainWidthLoc;
            ty += Params.terrainHeightLoc;
            //end modified
