 ...
 * @author David
 */
public class StorageCostControl implements Controller {
    private Nifty nifty;
    ...
    public void onUpdateButtonClicked(final String id, final ButtonClickedEvent event) {
        ...
        nifty.getScreen("layerScreen").findElementByName("winGSC_Element").getControl(GameSetupControl.class).setupStorageDone();
    }
}
