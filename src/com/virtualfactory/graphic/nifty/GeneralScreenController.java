...
import com.virtualfactory.graphic.nifty.controls.ActivityControl;
import com.virtualfactory.graphic.nifty.controls.AssignOperatorControl;
import com.virtualfactory.graphic.nifty.controls.CharactersControl;
...
import com.virtualfactory.graphic.nifty.controls.PriorityControl;
import com.virtualfactory.graphic.nifty.controls.StationControl;
import com.virtualfactory.graphic.nifty.controls.StorageCostControl;
import com.virtualfactory.graphic.nifty.controls.StorageStationControl;
import com.virtualfactory.graphic.nifty.controls.SupplierControl;
import com.virtualfactory.graphic.nifty.controls.UnitLoadControl;
...
public class GeneralScreenController implements ScreenController, KeyInputHandler {
    private Nifty nifty;
...
//    private Label labelCurrentMoney;
    ...
    public GeneralScreenController(){
...
//        showHideDynamicSubLevelButtons(0);
    ...
    public void onAlphaSliderChange(final String id, final SliderChangedEvent event) {
        ...
        GameLogControl.addMessage(MessageType.Info, Messages.timeFactor.replace(Messages.wildCard, strTimeFactor));
...
//        this.labelCurrentMoney.setText(Params.moneySign + " " + Utils.formatValue2DecToString(currentMoney));
        if (currentMoney < 1000 && currentMoney > 980){
            GameLogControl.addMessage(MessageType.Notification, Messages.moneyBetween1000and980);
        ...
        if (currentMoney < 100){
            GameLogControl.addMessage(MessageType.Error, Messages.moneyLessThan100);
            if (callOnceNoMoney){
    ...
    public void playGameValidated(){
        gameEngine.updateLastActivitySystemTime();
        if (nifty.getScreen("layerScreen").findElementByName("winGSC_Element").getControl(GameSetupControl.class).isIsReadyToStart()){
            playGame();
        }else{
...
//            screen.findElementByName("imagePause").getRenderer(ImageRenderer.class).setImage(imagePauseRed);
            isGamePlaying = true;
            playPauseGame();
            GameLogControl.addMessage(MessageType.Info, Messages.gamePlay);
    ...
    public void forcePauseGame(){
        isGamePlaying = false;
        playPauseGame();
        GameLogControl.addMessage(MessageType.Info, Messages.gamePause);
    ...
    public void hideCurrentControlsWindow(){
        if (currentOptionselected.equals("buttonOptionControls")){
            if (currentDynamicButtonSelected.contains("Resources")){
                screen.findElementByName("winChC_Element").getControl(CharactersControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("PriorityActivities")){
                screen.findElementByName("winPrC_Element").getControl(PriorityControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("AssignOperators")){
                screen.findElementByName("winAsOpC_Element").getControl(AssignOperatorControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("UnitLoad")){
                screen.findElementByName("winULC_Element").getControl(UnitLoadControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("AllocateStorages")){
                screen.findElementByName("winASCC_Element").getControl(StorageCostControl.class).loadWindowControl(gameEngine, -1, null);
            }
        }else
        if (currentOptionselected.equals("buttonOptionActivities")){
            screen.findElementByName("winAC_Element").getControl(ActivityControl.class).loadWindowControl(gameEngine, -1, TypeActivity.None, null);
        }else
        if (currentOptionselected.equals("buttonOptionUtilities")){
            if (currentDynamicButtonSelected.contains("Station")){
                screen.findElementByName("winSSC_Element").getControl(StorageStationControl.class).loadWindowControl(gameEngine,-1,null);
//                screen.findElementByName("winSC_Element").getControl(StationControl.class).loadWindowControl(gameEngine, -1, null);
            ...
            if (currentDynamicButtonSelected.contains("Machine") || currentDynamicButtonSelected.contains("Equipment")){
                screen.findElementByName("winMC_Element").getControl(MachineControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("Operator")){
                screen.findElementByName("winOC_Element").getControl(OperatorControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("Part")){
                screen.findElementByName("winPC_Element").getControl(PartControl.class).loadWindowControl(gameEngine, -1, null);
            }else
            if (currentDynamicButtonSelected.contains("Supplier")){
                screen.findElementByName("winSuC_Element").getControl(SupplierControl.class).loadWindowControl(gameEngine, -1, null);
            }
        }else
...
//            }
//            screen.findElementByName("winAC_Element").getControl(ActivityControl.class).loadWindowControl(gameEngine, tempIdActivity, tempActivityType, null);
//        }else
//        if (currentDynamicButtonSelected.contains("Station")){
...
//                        screen.findElementByName("winSSC_Element").getControl(StorageStationControl.class).loadWindowControl(gameEngine,temp.getIdStation(),null);
//                    else
...
//            screen.findElementByName("winMC_Element").getControl(MachineControl.class).loadWindowControl(gameEngine, Integer.valueOf(currentDynamicSubLevelButtonSelected.replace(" ", "").replace("Machine", "").replace("(", "").replace(")", "").replace(Params.active, "").replace(Params.inactive, "")), null);
//            screen.findElementByName("winMC_Element").getControl(MachineControl.class).setIdButton(id);
//        }else
//        if (currentDynamicButtonSelected.contains("Equipment")){
//            screen.findElementByName("winMC_Element").getControl(MachineControl.class).loadWindowControl(gameEngine, Integer.valueOf(currentDynamicSubLevelButtonSelected.replace(" ", "").replace("Equipment", "").replace("(", "").replace(")", "").replace(Params.active, "").replace(Params.inactive, "")), null);
//            screen.findElementByName("winMC_Element").getControl(MachineControl.class).setIdButton(id);
//        }else
//        if (currentDynamicButtonSelected.contains("Operator")){
//            screen.findElementByName("winOC_Element").getControl(OperatorControl.class).loadWindowControl(gameEngine, Integer.valueOf(currentDynamicSubLevelButtonSelected.replace(" ", "").replace("(", "").replace(")", "").replace("Operator", "").replace("Material", "").replace("Handler", "").replace("Ope", "").replace(Params.opeActive, "").replace(Params.opeInactive, "").replace(OperatorCategory.Versatile.toString(), "")), null);
//            screen.findElementByName("winOC_Element").getControl(OperatorControl.class).setIdButton(id);
//        }else
//        if (currentDynamicButtonSelected.contains("Part")){
//            screen.findElementByName("winPC_Element").getControl(PartControl.class).loadWindowControl(gameEngine, Integer.valueOf(currentDynamicSubLevelButtonSelected.replace(" ", "").replace("Part", "")), null);
//        }else
//        if (currentDynamicButtonSelected.contains("Supplier")){
//            screen.findElementByName("winSuC_Element").getControl(SupplierControl.class).loadWindowControl(gameEngine, Integer.valueOf(currentDynamicSubLevelButtonSelected.replace(" ", "").replace("Supplier", "")), null);
//        }
    }
...
//                    screen.findElementByName("winFCC_Element").getControl(FlowChartControl.class).loadWindowControl(gameEngine, -1, null);
//                }
//            }            
            currentDynamicButtonSelected = "";
            return;
...
//            }else
//            if (currentDynamicButtonSelected.contains("FlowChart")){
//                screen.findElementByName("winFCC_Element").getControl(FlowChartControl.class).loadWindowControl(gameEngine, 0, null);
//            }
//        }else
        if (currentOptionselected.equals("buttonOptionControls")){
            if (currentDynamicButtonSelected.contains("Resources")){
                screen.findElementByName("winChC_Element").getControl(CharactersControl.class).loadWindowControl(gameEngine, 0, null);
            }else
            if (currentDynamicButtonSelected.contains("PriorityActivities")){
                screen.findElementByName("winPrC_Element").getControl(PriorityControl.class).loadWindowControl(gameEngine, 0, null);
            }else
            if (currentDynamicButtonSelected.contains("AssignOperators")){
                screen.findElementByName("winAsOpC_Element").getControl(AssignOperatorControl.class).loadWindowControl(gameEngine, 0, null);
            }else
            if (currentDynamicButtonSelected.contains("UnitLoad")){
                screen.findElementByName("winULC_Element").getControl(UnitLoadControl.class).loadWindowControl(gameEngine, 0, null);
            }else
            if (currentDynamicButtonSelected.contains("AllocateStorages")){
                screen.findElementByName("winASCC_Element").getControl(StorageCostControl.class).loadWindowControl(gameEngine, 0, null);
            }
        }else
        if (currentOptionselected.equals("buttonOptionActivities")){
            TypeActivity tempActivityType = TypeActivity.None;
...
//                }
            ...
            screen.findElementByName("winAC_Element").getControl(ActivityControl.class).loadWindowControl(gameEngine, 0, tempActivityType, null);
        }else
        if (currentOptionselected.equals("buttonOptionUtilities")){
//            Button dynamicButton;
//            int position = 0;
...
//                    }
//                }
                screen.findElementByName("winSSC_Element").getControl(StorageStationControl.class).loadWindowControl(gameEngine,Params.stationList,null);
            }else
            if (currentDynamicButtonSelected.contains("Machine")){
...
//                    position++;
//                }
                screen.findElementByName("winMC_Element").getControl(MachineControl.class).loadWindowControl(gameEngine, Params.machineList, null);
                screen.findElementByName("winMC_Element").getControl(MachineControl.class).setIdButton(id);
            }else
            if (currentDynamicButtonSelected.contains("Equipment")){
...
//                    position++;
//                }
                screen.findElementByName("winMC_Element").getControl(MachineControl.class).loadWindowControl(gameEngine, Params.equipmentList, null);
                screen.findElementByName("winMC_Element").getControl(MachineControl.class).setIdButton(id);
            }else
            if (currentDynamicButtonSelected.contains("Operator")){
...
//                    position++;
//                }
               screen.findElementByName("winOC_Element").getControl(OperatorControl.class).loadWindowControl(gameEngine, Params.operatorList, null);
                screen.findElementByName("winOC_Element").getControl(OperatorControl.class).setIdButton(id);
            }else
            if (currentDynamicButtonSelected.contains("Part")){
...
//                    position++;
//                }
                screen.findElementByName("winPC_Element").getControl(PartControl.class).loadWindowControl(gameEngine, Params.partList, null);
            }else
            if (currentDynamicButtonSelected.contains("Supplier")){
...
//                    position++;
//                }
                screen.findElementByName("winSuC_Element").getControl(SupplierControl.class).loadWindowControl(gameEngine, Params.supplierList, null);
            }
        }
    }
...
//                screen.findElementByName("winGLC_Element").getControl(GameLogControl.class).loadWindowControl(gameEngine, -1, null);
//            else
//                screen.findElementByName("winGLC_Element").getControl(GameLogControl.class).loadWindowControl(gameEngine, 0, null);
...
//        }else
        ...
        if (id.equals("buttonStaticOptionGameSetup")){
            ...
            if (isVisibleWindowGameSetup)
                screen.findElementByName("winGSC_Element").getControl(GameSetupControl.class).loadWindowControl(gameEngine, -1, null);
            else
                screen.findElementByName("winGSC_Element").getControl(GameSetupControl.class).loadWindowControl(gameEngine, 0, null);
