 ...
 * @author David
 */
public class UnitLoadScreenController   implements Controller {
    private Nifty nifty;
...
//    }
    ...
    public void onUpdateButtonClicked(final String id, final ButtonClickedEvent event) {
        ...
        nifty.getScreen("layerScreen").findElementByName("winGSC_Element").getControl(GameSetupScreenController.class).setupUnitLoadDone();
        nifty.getScreen("layerScreen").findElementByName("winDashboard_Element").getControl(DashboardScreenController.class).updateTransportList();
    }
}
