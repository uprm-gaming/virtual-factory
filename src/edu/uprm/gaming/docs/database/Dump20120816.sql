...
INSERT INTO `t_activity` VALUES (1,0,1,'Purchase Part1','Purchase',1,4,8,'','',10.00,'',1),(2,0,2,'Purchase Part2','Purchase',2,5,8,'','',10.00,'',1),(3,0,3,'Assemble Part3','Operation',3,6,3,'','',10.00,'Operation',1),(4,0,1,'Store Part 1 from Receiving Dock to Station 7','Store',4,3,4,'','',10.00,'Transport',1),(5,0,2,'Store Part 2 from Receiving Dock to Station 7','Store',5,3,4,'','',10.00,'Transport',1),(6,0,3,'Move Part3 in Station1 to Storage','Store',6,7,5,'','',10.00,'Transport',1),(7,0,3,'Transport Part3 from Station1 to Ship Station','Store',7,8,6,'','',10.00,'Transport',1),(8,0,3,'Ship Part3','Ship',8,0,10,'','',10.00,'',1),(9,0,1,'Move Par 1 from Station 7 to Station 1','Store',0,0,0,'','',10.00,'Transport',1),(10,0,2,'Move Part 2 from Station 7 to Station 1','Store',0,0,0,'','',10.00,'Transport',1);
...
INSERT INTO `t_bucket` VALUES (1,1,0,80,'EACH',0,1,'Input',0,0,'Activate'),(1,2,0,200,'EACH',0,1,'Output',0,0,'Activate'),(1,3,0,500,'EACH',0,1,'Both',0,0,'Activate'),(1,4,0,100,'EACH',0,1,'Input',0,0,'Activate'),(1,7,0,100,'EACH',0,1,'Both',0,0,'Activate'),(2,1,0,80,'EACH',0,2,'Input',0,0,'Activate'),(2,2,0,100,'EACH',0,2,'Output',0,0,'Activate'),(2,3,0,250,'EACH',0,2,'Both',0,0,'Activate'),(2,4,0,100,'EACH',0,2,'Input',0,0,'Activate'),(2,7,0,100,'EACH',0,2,'Both',0,0,'Activate'),(3,1,0,25,'EACH',0,3,'Output',0,0,'Activate'),(3,3,0,125,'EACH',0,3,'Both',0,0,'Activate'),(3,4,0,100,'EACH',0,3,'Input',0,0,'Activate');
...
INSERT INTO `t_game` VALUES (0,'2012-08-02 16:46:45',1,8176.70,0,0,0,0,0,1,'CPU','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create Part 3'),(0,'2012-08-02 18:02:30',3,8176.70,0,0,0,0,0,1,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create Part 3'),(0,'2012-08-14 14:51:51',4,8904.63,48,2,1,0,84.01700000000176,0.125,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Completed',1,2,0,'Create Part 3'),(0,'2012-08-15 12:17:25',5,8176.70,0,0,0,0,0,1,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create Part 3');
...
INSERT INTO `t_operator` VALUES (1,0,'Pepe',8.00,'Idle','User','-1',0,0,0,0,20.00,0,-1,0,0,'None',0,'Activate'),(2,0,'Bob',8.00,'Idle','User','-1',0,0,0,0,22.00,0,-1,0,0,'None',0,'Activate'),(3,0,'Juan',8.00,'Idle','User','-1',0,0,0,0,25.00,0,-1,0,0,'None',0,'Activate'),(4,0,'Maria',8.00,'Idle','User','-1',0,0,0,0,15.00,0,-1,0,0,'None',0,'Activate'),(5,0,'Luis',10.00,'Idle','User','-1',0,0,0,0,30.00,0,-1,0,0,'None',0,'Activate'),(6,0,'Carlos',12.00,'Idle','User','-1',0,0,0,0,35.00,0,-1,0,0,'None',0,'Activate');
...
INSERT INTO `t_part` VALUES (1,0,'Part One','EACH',100.00,100.00,100,0,0.25,'User','Models/Screw/screw.j3o',0.01,'Red',0.97),(2,0,'Part Two','EACH',100.00,100.00,50,0,0.40,'User','Models/Screw2/screw2.j3o',0.01,'Blue',0.97),(3,0,'Part Three','EACH',300.00,300.00,25,0,2.00,'User','Models/Chair/chair.j3o',0.05,'Green',0.97);
...
INSERT INTO `t_station` VALUES (1,0,'Station to create part 3',100,-40,40.00,40.00,1.00,25,25,'Idle','User','AssemblyZone',5.00),(2,0,'Receiving Dock',-120,-70,30.00,30.00,1.00,0,50,'Idle','User','PurchaseZone',5.00),(3,0,'StorageFG',240,10,50.00,50.00,1.00,200,200,'Idle','User','StorageFG',5.00),(4,0,'Ship Station',-120,70,30.00,30.00,1.00,200,200,'Idle','User','ShippingZone',5.00),(5,0,'Staff Zone',50,50,40.00,20.00,1.00,0,0,'Idle','User','StaffZone',5.00),(6,0,'Machine Zone',-60,50,60.00,20.00,1.00,0,0,'Idle','User','MachineZone',5.00),(7,0,'StorageRM',-30,-70,40.00,40.00,1.00,25,25,'Idle','User','StorageRM',5.00);
...
INSERT INTO t_game(id_game, date_time, id_player, current_money,
    ...
    id_phase, next_id_phase, id_terrain, objective)
...
-- Dump completed on 2012-08-16 13:49:32
