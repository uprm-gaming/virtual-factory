...
INSERT INTO `t_activity` VALUES (1,0,1,'Purchase Part1','Purchase',1,4,8,'','',10.00,'',7),(1,1,1,'Purchase Part1','Purchase',1,2,0,'','',0.00,'',7),(2,0,2,'Purchase Part2','Purchase',2,5,8,'','',10.00,'',7),(2,1,1,'Part1 from Purchase to StorageRM','Transport',2,3,0,'','',0.00,'Transport',6),(3,0,3,'Assemble Part3','Operation',3,6,3,'','',10.00,'Operation',4),(3,1,1,'Part1 from StorageRM to Assemble','Transport',3,4,0,'','',0.00,'Transport',5),(4,0,1,'Part1 from Purchase to StorageRM','Transport',4,9,4,'','',10.00,'Transport',6),(4,1,2,'Assemble Part2','Operation',4,5,0,'','',0.00,'Operation',4),(5,0,2,'Part2 from Purchase to StorageRM','Transport',5,10,4,'','',10.00,'Transport',6),(5,1,2,'Part2 from Assemble to StorageFG','Transport',5,6,0,'','',0.00,'Transport',3),(6,0,3,'Part3 from Assembly to StorageFG','Transport',6,7,5,'','',10.00,'Transport',3),(6,1,2,'Part2 from StorageFG to Shipping','Transport',6,7,0,'','',0.00,'Transport',2),(7,0,3,'Part3 from StorageFG to Shipping','Transport',7,8,6,'','',10.00,'Transport',2),(7,1,2,'Ship Part2','Ship',7,0,10,'','',0.00,'',1),(8,0,3,'Ship Part3','Ship',8,0,10,'','',10.00,'',1),(9,0,1,'Part1 from StorageRM to Assemble','Transport',9,3,0,'','',10.00,'Transport',5),(10,0,2,'Part2 from StorageRM to Assemble','Transport',10,3,0,'','',10.00,'Transport',5);
...
INSERT INTO `t_assembly_details` VALUES (2,1,1,1,'Part Two requires 1 unit of Part One'),(3,1,0,2,'Part3 requires 2 units of Part1'),(3,2,0,1,'Part3 requires 1 unit of Part2');
...
INSERT INTO `t_catalog` VALUES (1,1,0,0.00,'',8.00,0.00,10,0.15,50,0.12,100,0.10),(1,1,1,0.00,'',10.00,0.00,20,1.50,50,1.20,100,1.00),(1,2,0,0.00,'',8.00,0.00,10,0.30,25,0.25,50,0.20),(2,1,1,0.00,'',10.00,0.00,20,2.50,50,1.00,100,0.80);
...
INSERT INTO `t_game` VALUES (0,'2012-08-02 16:46:45',1,0.00,0,0,1,1,0,1,'CPU','Normal','Testing the description of the first EASY game',10000,20.00,'Phase2: 2purchases, 6transport, 1assembly, & orders','Locked',2,3,0,'Create and send part 3 when the orders arrive','phase2.png'),(0,'2012-08-02 18:02:30',3,8176.70,0,0,1,1,0,1,'USER','Normal','Testing the description of the first EASY game',10000,20.00,'Phase2: 2purchases, 6transport, 1assembly, & orders','Locked',2,3,0,'Create and send part 3 when the orders arrive','phase2.png'),(0,'2012-08-16 18:04:44',4,8808.15,2,2,1,1,151.5120000000029,0.25,'USER','Normal','Testing the description of the first EASY game',10000,20.00,'Phase2: 2purchases, 6transport, 1assembly, & orders','Locked',2,3,0,'Create and send part 3 when the orders arrive','phase2.png'),(0,'2012-08-15 12:17:25',5,8176.70,0,0,1,1,0,1,'USER','Normal','Testing the description of the first EASY game',10000,20.00,'Phase2: 2purchases, 6transport, 1assembly, & orders','Locked',2,3,0,'Create and send part 3 when the orders arrive','phase2.png'),(0,'2012-08-20 14:50:20',6,0.00,0,0,1,1,0,1,'USER','Normal','Testing the description of the first EASY game',10000,20.00,'Phase2: 2purchases, 6transport, 1assembly, & orders','Unlocked',2,3,0,'Create and send part 3 when the orders arrive','phase2.png'),(1,'2012-08-19 23:33:38',1,0.00,0,0,1,1,0,1,'CPU','Easy','Description of game level 1',5000,50.00,'Phase1: 1purchase, 4transport, 1assembly, & orders','Unlocked',1,2,0,'Create and ship part 2 when the orders arrive','phase1.png'),(1,'2012-08-20 14:50:21',6,0.00,0,0,1,1,0,1,'USER','Easy','Description of game level 1',5000,50.00,'Phase1: 1purchase, 4transport, 1assembly, & orders','Unlocked',1,2,0,'Create and ship part 2 when the orders arrive','phase1.png');
...
INSERT INTO `t_operation` VALUES (3,0,'Assemble Part3',0,1,2),(4,1,'',1,5,5);
...
INSERT INTO `t_order` VALUES (0,0,3,5,20,60,80.00,120.00),(0,1,2,20,50,120,80.00,120.00),(1,0,3,20,120,60,80.00,120.00),(1,1,2,40,70,120,80.00,120.00),(2,0,3,10,60,60,80.00,102.00),(2,1,2,30,50,120,80.00,120.00),(3,0,3,5,30,60,80.00,120.00),(3,1,2,40,50,120,80.00,120.00),(4,0,3,12,40,60,80.00,120.00),(4,1,2,20,50,120,80.00,120.00),(5,0,3,24,100,60,80.00,120.00),(5,1,2,50,80,120,80.00,120.00),(6,0,3,8,20,60,80.00,120.00),(6,1,2,45,65,120,80.00,120.00),(7,0,3,60,120,60,80.00,120.00),(7,1,2,10,20,120,80.00,120.00),(8,0,3,20,150,60,80.00,120.00),(8,1,2,30,40,120,80.00,120.00),(9,0,3,15,50,60,80.00,120.00),(9,1,2,20,20,120,80.00,120.00);
...
INSERT INTO `t_part` VALUES (1,0,'Part One','EACH',100.00,100.00,100,0,0.25,'User','Models/Screw/screw.j3o',0.01,'Red',0.97),(1,1,'Part One','EACH',100.00,100.00,50,0,5.00,'User','',0.00,'Red',0.95),(2,0,'Part Two','EACH',100.00,100.00,50,0,0.40,'User','Models/Screw2/screw2.j3o',0.01,'Blue',0.97),(2,1,'Part Two','EACH',100.00,100.00,50,0,5.00,'User','',0.00,'Blue',0.99),(3,0,'Part Three','EACH',300.00,300.00,25,0,2.00,'User','Models/Chair/chair.j3o',0.05,'Green',0.97);
...
INSERT INTO `t_player` VALUES (0,'DefaultPlayer','def','default@gaming.com','123456'),(1,'newUser','','new@email.com','123456'),(2,'user1','','user1@email.com','123456'),(3,'user2','','user2@email.com','123456'),(4,'yserYYY','','yyy@mail.com','123456'),(5,'usezzzz','','userz@mail.com','123456'),(6,'newMAil','','new@mail.com','123456');
...
INSERT INTO `t_purchase` VALUES (1,0,2,1,10,100),(1,1,3,1,20,20),(2,0,2,1,10,50);
...
INSERT INTO `t_ship` VALUES (7,1,7,1),(8,0,4,50);
...
INSERT INTO `t_skill` VALUES (0,0,'Pick up'),(0,1,'Pick up'),(1,0,'Move'),(1,1,'Move'),(2,0,'Placement'),(2,1,'Placement'),(3,0,'Store'),(3,1,'Store'),(4,0,'Operate'),(4,1,'Operate');
...
INSERT INTO `t_skill_activity` VALUES (2,0,1),(2,1,1),(2,2,1),(2,3,1),(2,4,1),(3,0,1),(3,1,1),(3,2,1),(3,3,1),(3,4,0),(3,4,1),(4,0,0),(4,1,0),(4,2,0),(4,3,0),(4,4,0),(4,4,1),(5,0,0),(5,0,1),(5,1,0),(5,1,1),(5,2,0),(5,2,1),(5,3,0),(5,3,1),(5,4,0),(5,4,1),(6,0,0),(6,0,1),(6,1,0),(6,1,1),(6,2,0),(6,2,1),(6,3,0),(6,3,1),(6,4,0),(6,4,1),(7,0,0),(7,1,0),(7,2,0),(7,3,0),(7,4,0),(9,0,0),(9,1,0),(9,2,0),(9,3,0),(9,4,0),(10,0,0),(10,1,0),(10,2,0),(10,3,0),(10,4,0);
...
INSERT INTO `t_skill_operator` VALUES (0,1,0,0.90),(0,1,1,0.95),(0,2,0,0.95),(0,2,1,0.85),(0,3,0,0.99),(0,3,1,0.88),(0,4,0,0.98),(0,4,1,0.87),(0,5,0,0.85),(0,5,1,0.90),(0,6,0,0.86),(0,6,1,0.88),(1,1,0,0.97),(1,1,1,0.90),(1,2,0,0.95),(1,2,1,0.91),(1,3,0,0.93),(1,3,1,0.94),(1,4,0,0.94),(1,4,1,0.91),(1,5,0,0.90),(1,5,1,0.95),(1,6,0,0.88),(1,6,1,0.90),(2,1,0,0.97),(2,1,1,0.99),(2,2,0,0.90),(2,2,1,0.94),(2,3,0,0.96),(2,3,1,0.97),(2,4,0,0.93),(2,4,1,0.94),(2,5,0,0.96),(2,5,1,0.91),(2,6,0,0.95),(2,6,1,0.89),(3,1,0,0.92),(3,1,1,0.88),(3,2,0,0.89),(3,2,1,0.97),(3,3,0,0.88),(3,3,1,0.91),(3,4,0,0.90),(3,4,1,0.97),(3,5,0,0.79),(3,5,1,0.99),(3,6,0,0.92),(3,6,1,0.95),(4,1,0,0.94),(4,1,1,0.93),(4,2,0,0.85),(4,2,1,0.99),(4,3,0,0.87),(4,3,1,0.90),(4,4,0,0.83),(4,4,1,0.99),(4,5,0,0.82),(4,5,1,0.97),(4,6,0,0.96),(4,6,1,0.97);
...
INSERT INTO `t_station` VALUES (1,0,'Assemble Zone',100,-70,40.00,40.00,1.00,25,25,'Idle','User','AssembleZone',5.00),(1,1,'Staff Zone',180,-80,40.00,20.00,1.00,0,0,'Idle','User','StaffZone',5.00),(2,0,'Receiving Dock',-120,-70,30.00,30.00,1.00,0,50,'Idle','User','PurchaseZone',5.00),(2,1,'Machine Zone',180,50,80.00,20.00,1.00,0,0,'Idle','User','MachineZone',5.00),(3,0,'StorageFG',100,50,50.00,50.00,1.00,200,200,'Idle','User','StorageFG',5.00),(3,1,'Receiving Dock',-120,-70,30.00,30.00,1.00,0,50,'Idle','User','PurchaseZone',5.00),(4,0,'Ship Station',-120,70,30.00,30.00,1.00,200,200,'Idle','User','ShippingZone',5.00),(4,1,'Storage RM',-30,-70,40.00,40.00,1.00,25,25,'Idle','User','StorageRM',5.00),(5,0,'Staff Zone',180,-80,40.00,20.00,1.00,0,0,'Idle','User','StaffZone',5.00),(5,1,'Assemble Zone',100,-70,40.00,40.00,1.00,25,25,'Idle','User','AssembleZone',5.00),(6,0,'Machine Zone',180,50,60.00,20.00,1.00,0,0,'Idle','User','MachineZone',5.00),(6,1,'Storage FG',100,50,50.00,50.00,1.00,200,200,'Idle','User','StorageFG',5.00),(7,0,'StorageRM',-30,-70,40.00,40.00,1.00,25,25,'Idle','User','StorageRM',5.00),(7,1,'Ship Station',-120,70,30.00,30.00,1.00,200,200,'Idle','User','ShippingZone',5.00);
...
INSERT INTO `t_supplier` VALUES (1,0,'Supplier Pepito',0,0,0.00),(1,1,'Supplier Coqui',0,0,0.00),(2,1,'Supplier Pepito',0,0,0.00);
...
INSERT INTO `t_transport_store` VALUES (2,1,10,3,4),(3,1,10,4,5),(4,0,10,2,7),(5,0,10,2,7),(5,1,5,5,6),(6,0,20,1,3),(6,1,12,6,7),(7,0,30,3,4),(9,0,10,7,1),(10,0,10,7,1);
...
-- Dump completed on 2012-08-20 16:45:52
