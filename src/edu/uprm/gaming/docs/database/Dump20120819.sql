...
INSERT INTO `t_game` VALUES (0,'2012-08-02 16:46:45',1,8176.70,0,0,1,1,0,1,'CPU','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create and send part 3 when the orders arrive','level2.png'),(0,'2012-08-02 18:02:30',3,8176.70,0,0,1,1,0,1,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create and send part 3 when the orders arrive','level2.png'),(0,'2012-08-16 18:04:44',4,8808.15,2,2,1,1,151.5120000000029,0.25,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Completed',1,2,0,'Create and send part 3 when the orders arrive','level2.png'),(0,'2012-08-15 12:17:25',5,8176.70,0,0,1,1,0,1,'USER','Easy','Testing the description of the first EASY game',10000,20.00,'Phase 1: 2purchases,1assembly,1ship','Unlocked',1,2,0,'Create and send part 3 when the orders arrive','level2.png');
...
-- Dump completed on 2012-08-19 22:59:46
